...
// Schema for the AI Meal Balancer request body
export const balanceMealSchema = z.object({
  mealText: z.string().trim().min(1, "Meal description is required").max(500, "Meal description must be 500 characters or less"),
});
